...
declare module '@ioc:Rlanz/Queue' {
    ...
    export interface QueueContract {
        dispatch<K extends keyof JobsList>(job: K, payload: DataForJob<K>, options?: DispatchOptions): Promise<Job | null>;
        dispatch<K extends string>(job: K, payload: DataForJob<K>, options?: DispatchOptions): Promise<Job | null>;
        process(queue: {
            queueName?: string;
        }): this;
